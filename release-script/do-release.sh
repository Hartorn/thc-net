...
echo "Cloning repo into thc-net"
git clone -q git@github.com:Hartorn/thc-net.git thc-net
...
docker run --rm -v ${PWD}/thc-net:/work -w /work thc-net:latest poetry build
...
docker run --rm -v ${PWD}/thc-net:/work -w /work thc-net:latest poetry publish -u ${pipyUser} -p ${pipyPassword}
